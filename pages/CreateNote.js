...
export default function CreateNote() {
    ...
    }, [modalRef, modalColors, modalReminder]);
                ...
                <div className={styles.formOptions}>
                    <div className={styles.formOptionsLeft}>
                        ...
                        <div className={styles.reminderContent}>
                            <button type="button" className={styles.btn} onClick={toggleModalReminderClick} ref={btnRef}>
                            ...
                            {modalReminder && <div className={styles.modalReminder} ref={modalRef}>
                        ...
                        <div className={styles.bgColorsContent}>
                            <button type="button" className={styles.btn} onClick={toggleModalColorsClick} ref={btnRef}>
                            ...
                            {modalColors && <div className={styles.modalColors} ref={modalRef}>
