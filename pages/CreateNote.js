                ...
                <div className="form-options">
                    <div className="form-options-left">
                        ...
                        <div className="reminder-content">
                            ...
                            {modalReminder && <Modal className="modal modal-create-note modal-reminder" ref={modalReminderRef}>
                        ...
                        <div className="bg-colors-content">
                            ...
                            {modalColors && <Modal className="modal modal-create-note modal-bg-colors" ref={modalColorsRef}>
