...
export default function Notes({ data }) {
  ...
  const modalSett = useRef(null);

  useEffect(() => {
    function handleOutsideClick(e) {
      if (modalSett.current && !modalSett.current.contains(e.target)) {
        ...
        <div className={styles.notesContent}>
          ...
          <div className={styles.noteContentAdd}>
            ...
            <div className={styles.notesSettings}>
              <button className={styles.notesSettingsBtn} onClick={toggleModalSettings}>
              ...
              {showModalSettings && <div className={styles.modalSettings} ref={modalSett}>
                <p>Settings</p>
                <hr />
