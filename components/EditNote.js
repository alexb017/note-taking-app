...
export default function EditNote(props) {
  ...
  useEffect(() => {
    function handleOutsideClick(e) {
      if (
        modalColorsRef.current &&
        !modalColorsRef.current.contains(e.target) &&
        !btnColorsRef.current.contains(e.target)
      ) {
  ...
  useEffect(() => {
    function handleOutsideClick(e) {
      if (
        modalReminderRef.current &&
        !modalReminderRef.current.contains(e.target) &&
        !btnReminderRef.current.contains(e.target)
      ) {
        ...
        >
          {props.imageSrc && (
            <div className="image-src-container">
              ...
              <div className="btn-image-src">
                <Button
                  className="btn-modal"
                  onClick={() => handleDeleteImage(details.id)}
                >
          ...
          <div className="form-content">
            <input
              ...
              placeholder="Title"
              value={title}
              onChange={(e) => handleUpdateTitle(e, details.id)}
            />
            <textarea
              type="text"
              rows="3"
              ...
              value={content}
              onChange={(e) => handleUpdateContent(e, details.id)}
            />
            <div className="date-time-content">
              {date && (
                <div
                  className="date-time-content-flex date-time-content-note"
                  onMouseEnter={() => props.setRemoveDate(true)}
                  onMouseLeave={() => props.setRemoveDate(false)}
                >
                  ...
                  <Button
                    className={`btn-date-time-remove ${
                      props.removeDate ? '' : 'hidden'
                    }`}
                    onClick={() => handleRemoveDateClick(details.id)}
                  >
            ...
            <div className="form-options">
              <div className="form-options-left">
                <div className="reminder-content">
                  <Button
                    className="btn-modal"
                    onClick={toggleModalReminderClick}
                    ref={btnReminderRef}
                  >
                  ...
                  {modalReminder && (
                    <Modal
                      className="modal modal-reminder note-modal-reminder"
                      ref={modalReminderRef}
                    >
                      <p className="reminder">Reminder:</p>
                      <Button
                        className="btn-reminder"
                        onClick={() => handleAddTodayReminderClick(details.id)}
                      >
                      ...
                      <Button
                        className="btn-reminder"
                        onClick={() =>
                          handleAddTomorrowReminderClick(details.id)
                        }
                      >
                        <div className="btn-reminder-format">
                          <p>Tomorrow</p>
                ...
                <div className="bg-colors-content">
                  <Button
                    className="btn-modal"
                    onClick={toggleModalColorsClick}
                    ref={btnColorsRef}
                  >
                  ...
                  {modalColors && (
                    <Modal className="modal modal-colors " ref={modalColorsRef}>
                      ...
                      <div className="list-colors">
                        <Palette
                          ...
                          onClick={() => addBackgroundColorClick('color-white')}
                        />
                        <Palette
                          red
                          sample={backgroundColor}
                          onClick={() => addBackgroundColorClick('color-red')}
                        />
                        <Palette
                          orange
                          sample={backgroundColor}
                          onClick={() =>
                            addBackgroundColorClick('color-orange')
                          }
                        />
                        <Palette
                          yellow
                          sample={backgroundColor}
                          onClick={() =>
                            addBackgroundColorClick('color-yellow')
                          }
                        />
                        <Palette
                          teal
                          sample={backgroundColor}
                          onClick={() => addBackgroundColorClick('color-teal')}
                        />
                        <Palette
                          blue
                          sample={backgroundColor}
                          onClick={() => addBackgroundColorClick('color-blue')}
                        />
                        <Palette
                          purple
                          sample={backgroundColor}
                          onClick={() =>
                            addBackgroundColorClick('color-purple')
                          }
                        />
                        <Palette
                          gray
                          sample={backgroundColor}
                          onClick={() => addBackgroundColorClick('color-gray')}
                        />
                      </div>
                    </Modal>
                  )}
                ...
                <div className="bg-image-change">
                  <label className="btn-modal">
                    ...
                    <input
                      type="file"
                      onChange={(e) => handleUploadImageSrc(e, details.id)}
                      accept="image/*"
                    />
                  </label>
                ...
                <div className="archive-content">
                  <Button
                    className="btn-modal"
                    onClick={() => props.onArchiveNote(details.id)}
                  >
                ...
                <div className="delete-content">
                  <Button
                    className="btn-modal"
                    onClick={() => props.onDeleteNote(details.id)}
                  >
              ...
              <Button onClick={props.onClose} className="btn-submit">
                Close
              </Button>
            </div>
          </div>
