    ...
    return (
        <nav className={styles.nav}>
            <div className={styles.navContent}>
                ...
                <button type="button" className={styles.btnMenuMobile} onClick={toggleMenuMobile}>
                ...
                {menuMobile && <div className={styles.modalMenu}>
                        ...
                        <Link href='/labels' className={router.pathname === "/labels" ? styles.active : ""}>
                            ...
                            <li className={styles.navLiMobile}>
                                <div className={styles.notesSettings}>
                                    ...
                                    {showModalSettings && <div className={styles.modalSettingsMobile} ref={modalRef}>
                                        <p>Settings</p>
                                        <hr />
                                        <button type='button' className={styles.btnAppearance}>
                                            Switch appearance
