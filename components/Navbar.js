    ...
    return (
        <nav className="nav">
            <div className="nav-content">
                ...
                <ul className="ul-nav">
                    <li className="li-nav">
                        <Link href='/' className={router.pathname === "/" ? "active" : ""}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 256 256"><path d="M208 32H48a16 16 0 0 0-16 16v160a16 16 0 0 0 16 16h108.69a15.86 15.86 0 0 0 11.31-4.69L219.31 168a15.86 15.86 0 0 0 4.69-11.31V48a16 16 0 0 0-16-16ZM48 48h160v104h-48a8 8 0 0 0-8 8v48H48Zm148.69 120L168 196.69V168Z" /></svg>
                            Notes
                        </Link>
                    </li>
                    <li className="li-nav">
                    ...
                    {/* <li className="li-nav">
                        <Link href='/labels' className={router.pathname === "/labels" ? "active" : ""}>
                ...
                <button type="button" className="btn-menu-mobile" onClick={toggleMenuMobile}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 256 256"><path d="M224 128a8 8 0 0 1-8 8H40a8 8 0 0 1 0-16h176a8 8 0 0 1 8 8ZM40 72h176a8 8 0 0 0 0-16H40a8 8 0 0 0 0 16Zm176 112H40a8 8 0 0 0 0 16h176a8 8 0 0 0 0-16Z" /></svg>
                </button>

                {menuMobile && <div className="modal-menu">
                        ...
                        <Link href='/labels' className={router.pathname === "/labels" ? "active" : ""}>
                            ...
                            <li className="nav-li-mobile">
                                <div className="notes-settings">
                                    ...
                                    {showModalSettings && <div className="modal-settings-mobile" ref={modalRef}>
                                        <p>Settings</p>
                                        <hr />
                                        <button type='button' className="btn-appearance">
                                            Switch appearance
