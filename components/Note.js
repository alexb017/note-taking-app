          ...
          <div className="top-note-content">
            ...
            {details.dateTime && (
              <div
                ...
                onMouseEnter={() => setRemoveDate(true)}
                onMouseLeave={() => setRemoveDate(false)}
              >
                ...
                <Button
                  className={`btn-date-time-remove ${
                    removeDate ? '' : 'btn-date-time-remove-hidden'
                  }`}
            ...
            <div className={`btns-list ${isModalSettingsOpen ? '' : 'hidden'}`}>
              {details.isDelete ? (
                <div className="btn-delete-note">
                  <Button
                    className="btn-modal"
                    onClick={() => handleRestoreDeleteNote(details.id)}
                  >
                ...
                <>
                  <div className="btn-edit-note">
                    <Button
                      className="btn-modal"
                      onClick={() => updateNoteModal(details.id)}
                    >
                    ...
                    {modalReminder && (
                      ...
                      >
                        ...
                        <Button
                          ...
                          onClick={() =>
                            handleAddTodayReminderClick(details.id)
                          }
                        >
                      ...
                      >
                        ...
                        <div className="list-colors">
                          <Palette
                            ...
                            onClick={() =>
                              addBackgroundColorClick('color-white')
                            }
                          />
                          <Palette
                            red
                          ...
                          <Palette
                            ...
                            sample={backgroundColor}
                            onClick={() =>
                              addBackgroundColorClick('color-teal')
                            }
                          />
                          <Palette
                            blue
                            sample={backgroundColor}
                            onClick={() =>
                              addBackgroundColorClick('color-blue')
                            }
                          />
                          <Palette
                            purple
                          ...
                          <Palette
                            ...
                            sample={backgroundColor}
                            onClick={() =>
                              addBackgroundColorClick('color-gray')
                            }
                          />
                        </div>
                      </Modal>
                  ...
                  <div className="btn-archive-note">
                    <Button
                      className="btn-modal"
                      onClick={() => handleArchiveNote(details.id)}
                    >
                      <Icon iconName="iconArchive" />
                    </Button>
                    <div className="btn-name-details">
                      {details.isArchive ? 'Unarchive' : 'Archive'}
                    </div>
                  </div>
                </>
              )}
              ...
              {!details.isDelete ? (
                <div className="btn-delete-note">
                  <Button
                    ...
                    onClick={() => handleDeleteNote(details.id)}
                  >
          ...
          <div className="btn-pin-content">
            {details.isPinned ? (
              <div className="btn-pin-note">
                <Button
                  className={`btn-modal ${isModalSettingsOpen ? '' : 'hidden'}`}
                  onClick={() => handlePinNote(details.id)}
                >
